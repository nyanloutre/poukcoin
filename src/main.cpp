...
uint256 hashGenesisBlock("0x35b4a9ca99064f402bc6218b060ce8987d11a47e2f6dd7bfcc4776b4aeff7e37");
...
const string strMessageMagic = "PoukCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.1 * 24 * 60 * 60; // PoukCoin: 0.35 days
static const int64 nTargetSpacing = 15; // PoukCoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal poukcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PoukCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x87bc8b47534f274a896550c993b638b0c784c78b324945bab08f1c538e5dd83e");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1416322928;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 388084558;

        if (fTestNet)
        {
            block.nTime    = 1416177047;
